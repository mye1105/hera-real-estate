...
function About(){
  return(
    <div className="about">
      <div>
        <h2 className='Welcome'>Welcome to Hera's Dream Dwellings</h2>
      ...
      <div>
        <h2 className='Welcome'>Our mission</h2>
      ...
      <div>
        <h2 className='Welcome'>A Legacy of Trust and Expertise</h2>
      ...
      <div>
        <h2 className='Welcome'>Meet Our Team</h2>
    ...
    <div>
        <h2 className='Welcome'>Client-Centric Excellence</h2>
    ...
    <div>
        <h2 className='Welcome'>Building Communities Togethere</h2>
    ...
    <div>
        <h2 className='Welcome'>Looking to the Future</h2>
